...
// `SnapArea` lives in SnappingManager.swift (the classic edge-snap drag path that
// owns it, restored alongside the rest of that path). The compound calculations
// below return it.
